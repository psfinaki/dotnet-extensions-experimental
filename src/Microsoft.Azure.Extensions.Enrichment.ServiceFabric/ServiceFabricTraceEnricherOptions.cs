...
/// <summary>
/// Options for the Service Fabric trace enricher.
/// </summary>
public class ServiceFabricTraceEnricherOptions
{
    /// <summary>
    ...
    /// Default set to <see langword="false"/>.
    /// </remarks>
    public bool PartitionId { get; set; }
    ...
    /// Default set to <see langword="false"/>.
    /// </remarks>
    public bool ReplicaOrInstanceId { get; set; }
